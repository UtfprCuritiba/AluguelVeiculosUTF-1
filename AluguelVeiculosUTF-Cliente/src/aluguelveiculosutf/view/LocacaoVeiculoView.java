...
public class LocacaoVeiculoView extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LocacaoVeiculoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LocacaoVeiculoView dialog = new LocacaoVeiculoView(new javax.swing.JFrame(), true);
